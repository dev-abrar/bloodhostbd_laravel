                    ...
                    <div class="row">
                        <div class="col-lg-3 col-sm-6">
                           <div class="search_item">
                            ...
                            <select class="form-control blood_id"  id="blood_id">
                        ...
                        <div class="col-lg-3 col-sm-6">
                           <div class="search_item">
                            ...
                            <select class="custom-select city_id" id="city_id">
                        ...
                        <div class="col-lg-3 col-sm-6">
                           <div class="search_item">
                            ...
                            <select class=" custom-select subcity_id" id="subcity_id">
                                <option value="">--select blood upazila--</option>
