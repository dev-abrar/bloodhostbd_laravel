...
Route::get('/donor/history/{donor_id}', [BloodController::class, 'donor_history'])->name('donor.history')->middleware('auth');
Route::post('/donor/add/history/', [BloodController::class, 'donor_history_store'])->name('donor.history.store')->middleware('auth');
